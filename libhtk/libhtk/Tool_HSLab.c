...
int main_HSLab(int argc, char *argv[])
{
   char *s;

   void InitialiseHSLab(void);
   void LoadFiles(void);
   ...
   InitialiseHSLab(); LoadFiles(); hRedrawWindow();
